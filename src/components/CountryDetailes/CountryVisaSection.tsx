      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-red-50 border border-red-100 rounded-lg p-4 text-sm">
            ...
            <ul className="space-y-1 text-gray-600">
              <li>
                • Insufficient financial evidence or funds not held for required
                period
              </li>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {workOpportunitiesData.map((section, index) => (
              <div key={index} className="bg-white rounded-xl border shadow-sm">
                <div className={`${section.color} text-white p-4 rounded-t-xl`}>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <h5 className="font-medium mb-2">Average Graduate Salaries</h5>
                <ul className="space-y-1 text-gray-600 text-sm">
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-100">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                The UK Government continues to support the Graduate Route visa,
                allowing international students to work or seek employment after
                completing their degrees. This demonstrates the UK's commitment
                to attracting international talent and providing genuine career
