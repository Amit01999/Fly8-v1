      ...
      <div className="max-container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="heading-lg mb-6">Begin Your Global Education Journey Today</h2>
            <p className="text-xl text-gray-600 mb-8">
              Join over 125,000 students who've found their perfect educational match with Fly8. Our platform makes international education accessible, affordable, and achievable.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">1,500+ institutions in 50+ countries</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">24/7 guidance from application to arrival</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">$40M+ in scholarships secured for students</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">98% visa approval rate for our applicants</p>
                </div>
              </div>
            </div>
          ...
          >
            <h3 className="text-2xl font-bold mb-6 text-center">Ready to Take the First Step?</h3>
            ...
            <form className="space-y-4">
              ...
              <div>
                <label htmlFor="interest" className="text-sm font-medium text-gray-700 block mb-1">Area of Interest</label>
                <select 
                  id="interest" 
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary/50"
                >
