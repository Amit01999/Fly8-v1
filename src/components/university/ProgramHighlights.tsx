...
// Define the shape of the program data to match University interface
export interface Program {
  title: string;
  duration: string;
  type: string;
  popular: boolean;
  icon?: string; // Make icon optional and a string to match University interface
}
...
export function ProgramHighlights({
  ...
  const ProgramCard = ({
    ...
    const IconComponent =
      program.icon && iconMap[program.icon] ? iconMap[program.icon] : BookOpen;
