...
export default function TopDestinations() {
  ...
  return (
    <>
      {/* ScrollToTop triggers on route change */}
      <ScrollToTop />
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-16">
            ...
            <div className="text-center lg:text-left w-full lg:w-2/5">
              ...
              >
                ...
                universities to the admission process and beyond, we've curated
                a comprehensive guide to help you navigate the exciting realm of
