...
}
{
  /* <div className="lg:col-span-1 flex justify-center lg:justify-start">
            <div className="relative group">
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-400/30 to-purple-400/30 rounded-2xl blur-lg group-hover:blur-xl transition-all duration-500 opacity-60"></div>
              <div className="relative bg-white p-4 rounded-2xl shadow-2xl border border-white/50 backdrop-blur-sm">
                <img
                ...
                <div
                  className="absolute -bottom-4 -left-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg animate-bounce"
