...
const statsData = [
  {
    ...
    icon: CustomIcons.School,
    countTo: 3000,
    label: 'Worldwide Universities',
    suffix: '+',
    gradient: 'from-sky-500 to-blue-500',
    bg: 'from-sky-300 to-blue-300',
  },
  {
    id: 2,
    icon: CustomIcons.Award,
  ...
  },
  {
    ...
    bg: 'from-teal-300 to-emerald-300',
  },
  {
    id: 4,
    icon: CustomIcons.Clock,
    countTo: 220,
    label: 'Free Consultation Hours',
    suffix: '+',
    gradient: 'from-indigo-500 to-cyan-500',
    bg: 'from-indigo-300 to-cyan-300',
  },
  {
    id: 5,
    icon: CustomIcons.GraduationCap,
    countTo: 20,
    label: 'Study Abroad Seminars',
    suffix: '+',
    gradient: 'from-blue-500 to-indigo-500',
    bg: 'from-blue-300 to-indigo-300',
  },
  {
    id: 6,
    icon: CustomIcons.MapPin,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
            className="inline-block mb-3 px-4 py-1 rounded-full bg-gradient-to-r from-sky-100 to-blue-100"
          >
            <span className="text-sm font-medium bg-clip-text text-transparent bg-gradient-to-r from-sky-600 to-blue-600">
              Trusted Worldwide
            </span>
          </motion.div>

          <motion.h2
            className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            viewport={{ once: true }}
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            We connect students to thousands of universities with support,
            scholarships, and lifelong success stories.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-5 lg:gap-6">
          {statsData.map((stat, index) => (
            ...
            >
              ...
              {/* Card container with fixed height and width */}
              <div className="relative w-full h-[240px] sm:h-[260px] bg-white/80 backdrop-blur-md rounded-3xl p-6 flex flex-col items-center justify-center shadow-md group-hover:shadow-xl border border-gray-100/50 transition-all duration-300">
                <motion.div
                  className={`p-4 rounded-2xl bg-gradient-to-br ${stat.bg} text-white shadow-md mb-4 group-hover:scale-110 transition-transform duration-300`}
                ...
                <h3
                  className={`text-3xl md:text-4xl font-bold mb-1 bg-clip-text text-transparent bg-gradient-to-r ${stat.gradient}`}
                >
                  <AnimatedCounter value={stat.countTo} suffix={stat.suffix} />
                </h3>
        ...
        >
          <a
            href="#learn-more"
            className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-sky-600 to-indigo-600 text-white font-medium shadow-md hover:shadow-lg transition-all duration-300 hover:from-blue-700 hover:to-indigo-700"
          >
            Discover More
            <svg
              className="ml-2 h-5 w-5"
