...
// Mock data for demo
const mockCountries = ["USA", "UK", "Canada", "Australia", "Germany", "France", "Singapore", "Japan"];
const mockFields = ["Business", "Engineering", "Computer Science", "Medicine", "Arts", "Law", "Education", "Science"];
...
const CourseFinder = () => {
  ...
  const filteredCourses = mockCourses.filter(course => {
    ...
    if (activeFilters.country && course.university.country !== activeFilters.country) {
      return false;
    }
    
    if (activeFilters.fieldOfStudy && course.field !== activeFilters.fieldOfStudy) {
      return false;
    }
    ...
    if (
      (activeFilters.feesMin !== undefined && course.fee < activeFilters.feesMin) ||
      (activeFilters.feesMax !== undefined && course.fee > activeFilters.feesMax)
    ) {
      return false;
    }
    ...
    <>
      ...
      <PageContainer>
        ...
        {filteredCourses.length > 0 ? (
          <div className={`grid ${currentView === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6' : 'grid-cols-1 gap-4'}`}>
          ...
          <div className="text-center py-12">
            <h3 className="text-lg font-medium">No courses match your filters</h3>
