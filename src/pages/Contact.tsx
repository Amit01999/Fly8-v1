        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          {[
            ...
            },
            {
              icon: <Phone className="text-primary" />,
              title: 'Call Us',
              content: '+880 1686-395927',
              details: 'Mon-Fri from 9am to 6pm',
            },
            {
              icon: <MapPin className="text-primary" />,
              title: 'Head Office',
              content: 'Munna Tower, 6th Floor, Shib Bari, Khulna 9100',
              details: 'Bangladesh',
            },
          ].map((item, index) => (
            <motion.div
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  {[
                    {
                      city: 'Head Office, Khulna',
                      country: 'Bangladesh',
                      countryCode: 'BD',
                      address: 'Munna Tower, 6th Floor, Shib Bari, Khulna 9100',
                      flag: '🇧🇩',
                    },
                    {
                      city: 'Dhaka',
                    ...
                    },
                    {
                      ...
                      countryCode: 'BD',
                      address:
                        '3rd Floor of Dorjibari, Alokar Mor, Rajshahi, Bangladesh',
                      flag: '🇧🇩',
                    },
                    {
                      city: 'Chittagong',
                      ...
                      countryCode: 'BD',
                      address:
                        'Epic Emdad Heights Chattoshawri circle, Mehedibag (Ebl building) Flat B-8 (left side), Chittagong, Bangladesh',
                      flag: '🇧🇩',
                    },
                    {
                      city: 'London',
